...
export const exportTablePDF = ( dataTable: Data[], cols: Cols[], options: Options = {} ) => {
  ...
  // Siiiii dynamicFinalContent & afterTable.dynamicContent sirven para lo mismo
...
/**
 * Obtener medidas de la hoja actual (del PDF)
 */
...
//ToDo: por terminar esta funcion
const showMarginsToPagePDF = (doc: jsPDF) => {
...
export const addHeaderPDF = (doc: jsPDF, options: OptionsHeader = {}) => {
  ...
  //? Show page margins
  showMargins && showMarginsToPagePDF(doc)
}
...
/**
 * Transforma el array de que se le pasa a un componente tabla para 
 * indicar las columnas y lo adapta para crear un pdf con tabla
 */
