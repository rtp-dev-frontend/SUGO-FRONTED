...
export const PVestados = () => {
    ...
    const { sugo2cas0b1, sugo2cas0b2, sugo2cas0b3 } = useAuthStore( s => s.permisosSUGO )
    ...
    <> 
        ...
        <div className='flex-center align-items-stretch gap-2'>
            ...
            { userModulo === 0 &&
            <div className='absolute' style={{ left: '2rem' }}>
        ...
        { showPanels && panel == 0 &&
            <TablasDespachosRecepciones moduloInput={modulo} />
        }
        { showPanels && panel == 1 &&
            <TablaPVestado moduloInput={modulo} />
        }
        { showPanels && panel == 2 &&
            <TablaEcosEnRuta moduloInput={modulo} />
        }
...
const ReportePVestados = () => {
    ...
    const onSubmit = async(d: Form) => {
        ...
        let query = `eco=${data.eco}&fecha_ini=${fecha_ini}&fecha_fin=${fecha_fin}`
